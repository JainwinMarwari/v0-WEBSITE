...
export function FinancialDisclaimer() {
  return (
    <Alert className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200 dark:from-blue-950/20 dark:to-indigo-950/20 dark:border-blue-800/30">
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-blue-800 dark:text-blue-200">Important Disclaimer</span>
          </div>
