  ...
  const metrics = [
    {
      ...
      icon: TrendingUp,
      color: portfolioData.cagr > 15 ? "text-green-400" : "text-yellow-400",
      bgColor: portfolioData.cagr > 15 ? "bg-green-500/10" : "bg-yellow-500/10",
    },
    {
      title: "Sharpe Ratio",
      ...
      icon: Target,
      color: portfolioData.sharpeRatio > 1 ? "text-green-400" : "text-yellow-400",
      bgColor: portfolioData.sharpeRatio > 1 ? "bg-green-500/10" : "bg-yellow-500/10",
    },
    {
      title: "Max Drawdown",
    ...
    },
    {
      ...
      icon: Activity,
      color: portfolioData.volatility < 20 ? "text-green-400" : "text-yellow-400",
      bgColor: portfolioData.volatility < 20 ? "bg-green-500/10" : "bg-yellow-500/10",
    },
    {
      title: "Total Return",
